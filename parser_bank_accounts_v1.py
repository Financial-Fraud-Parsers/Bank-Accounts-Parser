...
if __name__ == '__main__':
    ...
    textdoc_paths = glob.glob(r'C:/Users/kaurm/Desktop/OCR/Navy-Federal-Project/Data/July/BankAccounts/Textfiles/*.txt')
    ...
    with open('july_bank_accounts'+'.csv','w', newline='', encoding='utf-8') as f1:
